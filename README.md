...
<body>
       ...
       <p>Seja bem-vindo à <i>branch</i> da quarta entrega do RoadTracker!</p>
...
<p align="justify">Para esta entrega, <i>sprint</i> 3, focamos nossos esforços na correção de bugs críticos no sistema, atendemos ao pedido do cliente de registrar as atividades dos usuários no sistema para auditorias (<i>logs</i> e relatórios de desempenho), configuramos um servidor para hospedar o nosso banco de dados e criamos um instalador do nosso sistema, visando aumentar a sua portabilidade.</p>
       <h3>Por que fizemos essa escolha? :grey_question: </h3>
<p align="justify">Na <i>sprint</i> anterior (<i>sprint</i> 2), haviamos finalizado toda a parte mais delicada do sistema e seu funcionamento, por isso, para esta entrega, nos restou melhorias de UX e atender a pedidos do cliente, como geração de relatórios, registro de <i>logs</i> e o desenvolvimento de um manual do usuário.</p>
...
<div>
       ...
       <div>
              ...
              <p align="justify">O gráfico acima exibe nosso progresso na realização das atividades que elaboramos para a quarta entrega. Desta vez a equipe se manteve focada na <i>sprint</i> e todas as atividades que estabelecemos para nós mesmos foram cumpridas sem grandes atrasos.</p>
       </div>
</div>
...
<div>
       <p align="justify">Diferente das outras entregas, dessa vez não adicionamos nada de novo aos perfis de motoristas e supervisores, apenas uma nova funcionalidade no perfil do administrador, responsável por gerar os dados da funcionalidade, que foi requisitada pelo cliente.</p>
...
<p align="justify">No GIF ao lado está o perfil do administrador completo, o qual também está disponível na <i>branch master</i>.
</p>
