...
<section id="user_stories">
     ...
     <h4>Primeira entrega :clock12:</h4>
     <p align="justify">A nossa primeira entrega contará com um CRUD dos funcionários das filais, que poderão ter os cargos de administrador, supervisor e motorista. Com isso, as filiais já poderão ter controle dos funcionários cadastrados sob seu nome e terão uma visão mais ampla das jornadas de trabalho de cada colaborador.</p>
